  ...
  if (variant === "buttons") {
    return (
      <div className={`flex gap-2 ${className}`}>
        ...
        >
          <span className="w-5 h-3 bg-blue-500 rounded-sm"></span>
          English
        </Button>
        <Button
        ...
        >
          <img
            src="data:image/svg+xml;base64,"
            alt="German flag"
            className="w-5 h-3"
          />
          Deutsch
