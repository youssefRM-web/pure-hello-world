...
import { X, ArrowLeft, MessageSquare, Calendar } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
interface LinkedSpaceTasksModalProps {
  isOpen: boolean;
  onClose: () => void;
  groupName: string;
  tasks: any[];
...
const LinkedSpaceTasksModal = ({
  isOpen,
  onClose,
  groupName,
  tasks,
}: LinkedSpaceTasksModalProps) => {
  const { t } = useLanguage();
...
export default LinkedSpaceTasksModal;
