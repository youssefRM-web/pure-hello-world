...
import LogoNav from 'assets/logo/Gothilium.png';
    ...
    <nav className={navStyles}>
      ...
      <div className={styles.container_bottom}>
        ...
        <div className={styles.container_menu}>
          <NavLink className={`${styles.link} ${styles.info_link}`} to='/collections/anime'>
            Anime
          </NavLink>
          <ul className={styles.info_list}>
            <li>
              <Link className={styles.link} to="/collections/adventure-time">
                Adventure Time
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link className={styles.link} to="/collections/jujutsu-kaisen">
                Jujitsu Kaisen
              </Link>
            </li>
          </ul>
        ...
        <div className={styles.container_menu}>
          <NavLink className={`${styles.link} ${styles.info_link}`} to='/collections/music'>
            Rock & Metal
          </NavLink>
          <ul className={styles.info_list} style={{left: '27.7rem'}}>
            <li>
              <Link className={styles.link} to="/products/adventure-time-Black">
                Metallica
              </Link>
            </li>
            <li>
          ...
          <li>
            <NavLink className={styles.link} to="/collections/hoodies-sweatshirts">
              TV shows
            </NavLink>
          </li>
          <li>
